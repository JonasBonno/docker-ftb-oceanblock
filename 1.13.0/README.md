...
<code>docker run --name [name of your data container] jonasbonno/ftb-oceanblock:1.13.0 echo 'Data-only container'</code>

Running ftb-oceanblock server:
<code>docker run --tty=true --interactive=true --detach=true --name [name of your container] --volumes-from [name of your data container] --publish=[port on your host]:25565 jonasbonno/ftb-oceanblock:1.13.0</code>
